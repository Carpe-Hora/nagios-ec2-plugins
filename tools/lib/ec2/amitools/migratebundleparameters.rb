...
class MigrateBundleParameters < ParametersBase
  ...
  LOCATION_DESCRIPTION = "The location of the bucket to upload to [EU,US,us-west-1,us-west-2,ap-southeast-1, ap-northeast-1]."
  ...
  def optional_params()
    ...
    on('--location LOCATION', LOCATION_DESCRIPTION) do |location|
      assert_option_in(location, ['EU', 'US', 'us-west-1', 'us-west-2', 'ap-southeast-1', 'ap-northeast-1'], '--location')
      @location = location
